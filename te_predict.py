...
# Load the model
model = load("limited_models/te_rf.joblib")

# Load the data
te_nn = pd.read_csv("nn_data/te_nn.csv")
...
players = players[players["position_group"] == "TE"]
...
for index, row in players.iterrows():
    ...
    most_recent_player_data = te_nn[te_nn["display_name"] == row["display_name"]]
...
print(predictions)
predictions.to_csv("final_data/te_final_predictions.csv", index=True)